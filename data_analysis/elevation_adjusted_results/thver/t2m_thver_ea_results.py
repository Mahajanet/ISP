...
plt.title("Daily Mean 2 m Temperature: Elev-Adjusted CARRA vs In Situ (Þverá, Station 2636)")
...
plt.title("Scatter: Elev-Adjusted CARRA vs In Situ 2 m Temperature")
