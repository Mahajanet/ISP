...
# --- 2) LOAD IN-SITU EXCEL (Station 2636) ---
...
plt.plot(aligned.index, aligned["In_Situ"],
         label="In Situ (Station 2636)", alpha=0.7)
plt.title("Fig 3.3.6 Daily 2 m Temperature: Gaussian vs In Situ (Þverfjall, Station 2636)")
...
plt.title("Fig 3.3.7 Scatter: Gaussian vs In Situ Temperature (Þverfjall)")
