...
plt.title("Fig 3.2.1 Daily Precipitation: IDW‐Interpolated CARRA vs In Situ (Ísafjörður)")
...
plt.title("Fig 3.1.2 Scatter: IDW‐Interpolated CARRA vs In Situ Precipitation")
