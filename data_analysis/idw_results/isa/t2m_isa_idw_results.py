...
plt.title("Fig 3.2.4 Daily 2m Temperature: IDW‐Interpolated CARRA vs In Situ (Ísafjörður)")
...
plt.title("Fig 3.2.5 scatter: IDW‐Interpolated CARRA vs In Situ T2M (Ísafjörður)")
