...
plt.title("Fig 3.2.6 Daily Mean 2 m Temperature: IDW-Interpolated CARRA vs In Situ (Þverá)")
...
plt.title("Fig 3.2.7 Scatter: IDW CARRA vs In Situ 2 m Temperature")
