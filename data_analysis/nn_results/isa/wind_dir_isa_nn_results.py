...
# --- Load and combine CARRA wind direction files for Ísafjörður ---
carra_files = sorted(glob("/Users/jahnavimahajan/Projects/ISP/raw_data/nn/wind_dir_nn/d10m_isa_nn/d10m_isa_*.nc")) 
if not carra_files:
    raise FileNotFoundError("No CARRA wind direction files found for Ísafjörður")
...
plt.title("Fig 3.1.8 Daily Wind Direction: CARRA vs In Situ (Ísafjörður)")
